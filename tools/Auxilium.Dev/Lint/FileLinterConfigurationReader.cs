...
internal class FileLinterConfigurationReader : ILinterConfigurationReader
{
    ...
    public LinterConfigurationResult Read()
    {
        var directory = Directory.GetCurrentDirectory();
        if (!Debugger.IsAttached)
        {
            directory = Path.Combine(directory, "tools", "Auxilium.Dev");
        }
